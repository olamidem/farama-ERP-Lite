...
export const EditStaffModal = ({
  ...
  return (
    <div id="edit-employee-modal" className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs z-100 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-2xl max-w-md w-full overflow-hidden text-left transition-colors">
        <div className="border-b border-slate-50 dark:border-slate-800 px-6 py-5 flex items-center justify-between">
          <h3 className="text-sm font-black text-slate-800 dark:text-slate-100 uppercase tracking-wider">Edit Operator Profile</h3>
          <button
            onClick={onClose}
